...
while True:
    ...
    with open(url_n, 'r') as f:
      ...
      """)
            ...
            """ +
                           """<br /><p>大腿(杆1)长　　　　   :&nbsp;<input type="text"  style="width:100px; height:30px;" name="l1" """ + """value='""" + str(
                    padog.l1) + """'/></p>""" + \
                           """<br /><p>小腿(杆2)长　　　　   :&nbsp;<input type="text"  style="width:100px; height:30px;" name="l2" """ + """value='""" + str(
                    padog.l2) + """'/></p>""" + \
                           """<br /><p>机器人长度　　 　　   :&nbsp;<input type="text"  style="width:100px; height:30px;" name="l" """ + """value='""" + str(
                    padog.l) + """'/></p>""" + \
                           """<br /><p>机器人宽度　　 　　   :&nbsp;<input type="text"  style="width:100px; height:30px;" name="b" """ + """value='""" + str(
                    padog.b) + """'/></p>""" + \
                           """<br /><p>机器人腿间距 　　　   :&nbsp;<input type="text"  style="width:100px; height:30px;" name="w" """ + """value='""" + str(
                    padog.w) + """'/></p>""" + \
                           """<br /><p>步频　　　　:&nbsp;<input type="text"  style="width:100px; height:30px;" name="speed" """ + """value='""" + str(
                    padog.speed) + """'/></p>""" + \
                           """<br /><p>抬腿高度　　　　:&nbsp;<input type="text"  style="width:100px; height:30px;" name="h" """ + """value='""" + str(
                    padog.h) + """'/></p>""" + \
                           """<br /><p>TROT前进重心调整P　:&nbsp;<input type="text"  style="width:100px; height:30px;" name="trot_cg_f" """ + """value='""" + str(
                    padog.trot_cg_f) + """'/></p>""" + \
                           """<br /><p>TROT后退重心调整P　:&nbsp;<input type="text"  style="width:100px; height:30px;" name="trot_cg_b" """ + """value='""" + str(
                    padog.trot_cg_b) + """'/></p>""" + \
                           """<br /><p>TROT转向重心调整P　:&nbsp;<input type="text"  style="width:100px; height:30px;" name="trot_cg_t" """ + """value='""" + str(
                    padog.trot_cg_t) + """'/></p>""")
                cl.sendall(
                    """<br /><p>高度调节P环　　　　　:&nbsp;<input type="text"  style="width:100px; height:30px;" name="Kp_H" """ + """value='""" + str(
                        padog.Kp_H) + """'/></p>""" + \
                    """<br /><p>俯仰姿态P环　　　　　:&nbsp;<input type="text"  style="width:100px; height:30px;" name="pit_Kp_G" """ + """value='""" + str(
                        padog.pit_Kp_G) + """'/></p>""" + \
                    """<br /><p>俯仰姿态D环　　　　　:&nbsp;<input type="text"  style="width:100px; height:30px;" name="pit_Kd_G" """ + """value='""" + str(
                        padog.pit_Kd_G) + """'/></p>""" + \
                    """<br /><p>滚转姿态P环　　　　　:&nbsp;<input type="text"  style="width:100px; height:30px;" name="rol_Kp_G" """ + """value='""" + str(
                        padog.rol_Kp_G) + """'/></p>""" + \
                    """<br /><p>滚转姿态D环　　　　　:&nbsp;<input type="text"  style="width:100px; height:30px;" name="rol_Kd_G" """ + """value='""" + str(
                        padog.rol_Kd_G) + """'/></p>""" + \
                    """<br /><p>平移姿态P环　　      :&nbsp;<input type="text"  style="width:100px; height:30px;" name="tran_mov_kp" """ + """value='""" + str(
                        padog.tran_mov_kp) + """'/></p>""" + \
                    """<br /><p>控制模式(0:网页 1:航模遥控 2:串口):&nbsp;<input type="text"  style="width:100px; height:30px;" name="CC_M" """ + """value='""" + str(
                        padog.CC_M) + """'/></p>""" + \
